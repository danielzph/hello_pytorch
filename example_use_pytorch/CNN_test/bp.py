...
df2=pd.read_csv("../../data/shiyan/f_ae03.csv")
train=df2[df2.columns[0:7]]

train=train.values.reshape(-1,3,7)
...
class Covn2D_BiLSTM(nn.Module):
    def __init__(self, in_channel=1, out_channel=1):
        ...
        self.V = 5
        self.embed1 = nn.Sequential(
            nn.Conv2d(in_channel, self.kernel_num, kernel_size=1),
        ...
        self.embed2 = nn.Sequential(
            ...
            nn.MaxPool2d(kernel_size=2, stride=2))
        self.hidden2label1 = nn.Sequential(nn.Linear(21 *2 * self.hidden_dim, self.hidden_dim * 3),
                                           nn.ReLU(),
                                           nn.Dropout())
